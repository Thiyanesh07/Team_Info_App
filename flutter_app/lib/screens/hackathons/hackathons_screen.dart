      ...
      child:
          Column(
                ...
                children: [
                  ...
                  Text(
                    'Log your first hackathon participation!',
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              controller: nameC,
              decoration: const InputDecoration(hintText: 'Hackathon Name *'),
            ),
...
class _HackathonCard extends StatelessWidget {
  ...
  Widget _statusBadge(String status) {
    final color = status == 'WINNER'
        ? AppColors.success
        : (status == 'PARTICIPATED' ? AppColors.primary : AppColors.warning);
    return Container(
